...
\end{equation*}
\begin{lem}
If for all $i \in [1, m]$ and some $x \in \mathbb{R}^n$ and an $e_j$:
\begin{equation*}
\frac{\partial f_i(x)}{\partial e_j} \ \text{exist}
\end{equation*}
then:
\begin{equation*}
\frac{\partial f(x)}{\partial e_j} \ \text{exists and } \frac{\partial f(x)}{\partial e_j} = \begin{bmatrix}
\frac{\partial f_1(x)}{\partial e_j}\\.\\.\\.\\\frac{\partial f_m(x)}{\partial e_j}
\end{bmatrix}
\end{equation*}
\end{lem}
\begin{proof}
