...
\end{proof}
Notice how (aside from the construction of the subsequence) did not use any properties specific to that of integers. This gives rise to nets as we only require the properties of directed sets. 
