...
\begin{equation*}
\forall \epsilon > 0, \exists \alpha_0 \in D, \forall \alpha \geq \alpha_0: x_\alpha \in B(c, \epsilon) \iff |x_\alpha - x| < \epsilon
\end{equation*}
so if our directed set $D = \mathbb{N}$, we obtain a sequence.
