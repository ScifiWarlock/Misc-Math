...
\begin{defn}
$x$ is a cluster point of $\{x_n : n \in \mathbb{N}\}$ if $\{x_n\}_{n \in \mathbb{N}}$ frequently visits all open neighborhoods of $x$.
\end{defn}
...
\end{equation*}
which permits $x_n = x$ unlike a \textbf{limit point of a set}.
