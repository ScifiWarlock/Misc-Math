...
\end{proof}
Notice how (aside from the construction of the subsequence) did not use any properties specific to that of integers. Another thing is the limit of a convergent sequence is a cluster point, but the converse is not necessarily true. This gives rise to nets as we only require the properties of directed sets. We define an additional useful property:
\begin{defn}
