...
\end{equation*}
where the marked point of the subintervals $[e, h], [h, t_j]$ is now $h$. Repeat this process for all $m$ points in $\Pi_\epsilon$. In the remaining subintervals without a partition point, choose that of $\Pi$ since it means these intervals do not contain any points of $\Pi_\epsilon$. Now observe:
\begin{equation*}
...
\begin{equation*}
|R(f, \Pi) - R(f, \Pi \cup \Pi_\epsilon)| \leqslant 2||f|| \cdot m \cdot \frac{\epsilon}{2(||f|| \cdot m + 1)} + \frac{\epsilon}{2} \leqslant \epsilon
\end{equation*}
