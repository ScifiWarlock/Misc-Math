...
\tableofcontents
\end{tcolorbox}
\textbf{NOTE:} Any sections/subsections marked with a (*) are extra sections and have been added to this document as extensions of introduced theory.
...
\end{equation*}
so, we see that the set of all upper-sums is bounded below by $-M(b-a)$ and the set of all lower-sums is bounded above by $M(b-a)$. We now prove the following:
\begin{equation*}
