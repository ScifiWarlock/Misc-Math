...
\end{equation*}
For brevity, we shall also use the following notation for Stieltjes sums:
\begin{equation*}
...
\end{equation*}
We can show that $\forall \epsilon > 0$ each $P_\epsilon$ is a cofinal subset of $P$ such that:
\begin{equation*}
...
\begin{equation*}
\Pi_0 \cup \Pi_\epsilon \supseteq \Pi_0 \implies \Pi_0 \cup \Pi_\epsilon \leq \Pi_0 \land \Pi_10\cup \Pi_\epsilon \in P_\epsilon
\end{equation*}
Since $P_\epsilon$ is cofinal, it is the domain for a (Kelley/Willard Subnet) under composition with the identity function.\\
