...
\end{lem}
Now consider a function $f: \mathbb{R} \xrightarrow{} \mathbb{R}$ with an uncountable number of discontinuities. Then $\exists n \in \mathbb{N}$ such that $[-n, n]$ has an uncountable number of discontinuities. 
